    ...
    <div className="bg-slate-100">
      <div className="max-w-7xl mx-auto p-3 md:p-8">
        ...
        <div className="flex justify-between items-center mb-3 md:mb-4">
          ...
          <p className="text-gray-600">Trending now! Shop our most-loved best sellers today.</p>
          </div>
          {!showAllProducts && products.length > visibleProducts && (
            <button
              onClick={handleViewAll}
              className="text-gray-500 text-lg font-sm hover:underline hidden md:block"
            >
              View All →
            </button>
          )}
